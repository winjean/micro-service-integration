...
//    }
    ...
    public static void appendBeanInfo(Object object, String user) {
        if(object instanceof BaseEntity){
            Date date =DateUtils.getDateTime();
            ((BaseEntity) object).setId(com.winjean.utils.StringUtils.getUUID());
    ...
    public static void updateBeanInfo(Object object, String user) {
